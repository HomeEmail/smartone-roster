	...
	var showRoster=function showRoster(){
		...
		try{
			for(var i=0; i<rosters.length; i++){
				...
				/*****dutyday list string*******/
				var dutyListStr='';//
				var dutyListH=memberGroupNum*34+memberArray.length*30;//列表高度
				...
				(function(){
					for(var jduty=0; jduty<dutyDays; jduty++){
						...
						if(isWeekend(currentDate)||isPH(currentDate)){
							weekendMarkStyle=' style="color:red;"';
						}
							...
							'<tr>'+
								'<td colspan="2" valign="top" style="border-bottom:1px #ccc solid;">'+
									'<div class="shift">'+
										...
										'<span class="shift-teamName" style="float:left; margin-left:10px; color:#333; font-size:16px;">tel:'+tphoneStr+'</span>'+
